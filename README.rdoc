...
- SproutCore 1.4.1 (gem install sproutcore -v=1.4.1)
...
You should now be able to see the app at http://localhost:4020/calendar, and the administrative back end at http://localhost:3000
